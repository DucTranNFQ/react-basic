...
export default function SignupForm() {
  ...
  return (
    <form className={clsx(styles.form)} onSubmit={formik.handleSubmit}>
      ...
      <Input disabled={true} type="text" placeholder="Email Address" className={styles.input} value={formik.values.email} onChange={formik.handleChange} onBlur={formik.handleBlur} name="email"/>
      <div className={clsx("w-100", "mb-3", styles.error)}>
        {formik.errors.email ? formik.errors.email : null}
      </div>
      <Input disabled type="password" placeholder="password" className={styles.input} value={formik.values.password} onChange={formik.handleChange} onBlur={formik.handleBlur} name="password"/>
      <div className={clsx("w-100", "mb-3", styles.error)}>
        {formik.errors.password ? formik.errors.password : null}
      </div>
      <Input disabled={true} type="password" placeholder="confirm password" className={styles.input} value={formik.values.confirmPassword} onChange={formik.handleChange} onBlur={formik.handleBlur} name="confirmPassword"/>
      <div className={clsx("w-100", "mb-3", styles.error)}>
